        ...
        for (int tc = ii(); tc > 0; tc--) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (c == 'P') {
                    ...
                    int x = ans1.get(0), y = ans1.get(1);
                    out.print(x + " " + y + " ");
                    String key = x + " " + y;
                    ArrayList<String> list = parking.get(key);
                    int length = list.indexOf(number) + 1;
                    out.print(floor(length, C) + " ");
                    out.println(slot(length, C));
                    list.remove(number);
