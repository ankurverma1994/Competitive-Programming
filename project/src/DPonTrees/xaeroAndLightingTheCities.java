...
class xaeroAndLightingTheCities {
    ...
    // red color 1
    // black color 0
//    long solve(int node, int color, int parent) {
//        if(light[node]==1){
//            long ans=0;
//            for (int v:tree[node])
//                if(v!=parent)
//                    ans+=Math.min(solve(v,0,node),solve(v,1,node));
//            return ans;
//        }
//        long ans=0;
//
//    }
    ...
    public static void main(String[] args) throws IOException {
        new Thread(null, () -> {
            try {
                new xaeroAndLightingTheCities().main1();
            } catch (IOException e) {
                e.printStackTrace();
