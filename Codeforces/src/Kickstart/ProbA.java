...
public class ProbA {
    ...
    void solve() {
        ...
        for (int tc = 1; tc <= test; tc++) {
            ...
            BigInteger ans = cube(m + 1);
            ans = ans.add(BigInteger.valueOf(n - m).multiply(sq(m)));
    ...
    BigInteger sq(int n) {
        ...
        return N.multiply(N1).multiply(N2).divide(six);
    }

    BigInteger cube(int n) {
        BigInteger N = BigInteger.valueOf(n);
        BigInteger sq = N.multiply(N);
        BigInteger sq1 = sq.subtract(BigInteger.ONE);
        BigInteger tw = BigInteger.valueOf(12);
        return sq.multiply(sq1).divide(tw);
    }
