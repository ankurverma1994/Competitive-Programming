...
class COMBINATORICS {
    ...
    */
    ...
    public double[] binomial_sum(int N, int K) {
        //@ http://math.stackexchange.com/questions/2135431/how-to-calculate-the-summation-sum-p-kn-binomnp-2n-quickly
        // cC0 + nC1 + nC2 + .. nCk
        int current_exponent = 0;
        double current_mantissa = 1.0;
        int total_exponent = 0;
        double total_mantissa = 1.0;
        for (int i = 1; i <= K; i++) {
            ...
            total_mantissa += current_mantissa * Math.pow(2, current_exponent - total_exponent);
        ...
        return new double[]{total_mantissa, total_exponent};
    }
}
